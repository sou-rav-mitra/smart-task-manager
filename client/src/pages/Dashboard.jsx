...
function Dashboard() {
  ...
  return (
    <div ref={vantaRef} className="flex min-h-screen" style={{ backgroundColor: "transparent" }}>
                      ...
                      {editingTask?._id === task._id ? (
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3
                              className="text-white font-medium text-sm break-words"
                              style={{
      ...
      <motion.button
        initial={{ background: "linear-gradient(135deg, #7c3aed, #6d28d9)" }}
        whileHover={{ background: "linear-gradient(135deg, #3afcff, #48ACF0)", scale: 1.02, boxShadow: "0 0 30px rgba(56, 189, 248, 0.5)" }}
        whileTap={{ scale: 0.95 }}
        ...
        style={{ background: "linear-gradient(135deg, #7c3aed, #6d28d9)", boxShadow: "0 0 20px rgba(124, 58, 237, 0.5)", zIndex: 50 }}
      >
        +
      </motion.button>
